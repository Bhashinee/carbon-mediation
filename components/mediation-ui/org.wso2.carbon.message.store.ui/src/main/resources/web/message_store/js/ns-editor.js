...
function deletensraw(i) {
    CARBON.showConfirmationDialog(messageStorei18n["ns.editor.delete.confirmation"], function() {
            ...
            for (k = 0; k < currentCount; k++) {
                ...
                if (uri != null && uri != undefined) {
                    ...
                    if(!isValidURI(uri.value)) {
                        CARBON.showWarningDialog(messageStorei18n["ns.editor.invalid.uri"] + uri.value);
                        return false;
                    }
                }
            }
