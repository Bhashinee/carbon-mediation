...
public class PublishEventMediator extends AbstractMediator {
	private static final String TASK_EXECUTING_TENANT_ID = "tenant.info.id";
	...
	public boolean mediate(MessageContext messageContext) {
		...
		if (messageContext.getProperty(TASK_EXECUTING_TENANT_ID) != null && messageContext
				.getProperty(TASK_EXECUTING_TENANT_ID) instanceof Integer) {
